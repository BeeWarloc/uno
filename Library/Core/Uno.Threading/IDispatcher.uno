...
namespace Uno.Threading
{
    ...
    public static class IDispatcherExtensions
    {
        ...
        public static TResult Invoke0<TResult>(this IDispatcher dispatcher, Func<TResult> func)
        {
            var closure = new Arg0InvokeFunc<TResult>(func);
            dispatcher.Invoke(closure.Run);
            return closure.ConsumeResult();
        }

        public static TResult Invoke1<T, TResult>(this IDispatcher dispatcher, Func<T, TResult> func, T arg)
        {
            var closure = new Arg1InvokeFunc<T, TResult>(func, arg);
            dispatcher.Invoke(closure.Run);
            return closure.ConsumeResult();
        }

        public static TResult Invoke2<T1, T2, TResult>(this IDispatcher dispatcher, Func<T1, T2, TResult> func, T1 arg1, T2 arg2)
        {
            var closure = new Arg2InvokeFunc<T1, T2, TResult>(func, arg1, arg2);
            dispatcher.Invoke(closure.Run);
            return closure.ConsumeResult();
        }

        public static TResult Invoke3<T1, T2, T3, TResult>(this IDispatcher dispatcher, Func<T1, T2, T3, TResult> func, T1 arg1, T2 arg2, T3 arg3)
        {
            var closure = new Arg3InvokeFunc<T1, T2, T3, TResult>(func, arg1, arg2, arg3);
            dispatcher.Invoke(closure.Run);
            return closure.ConsumeResult();
        }

        abstract class ArgInvokeFuncBase<TResult>
        {
            protected TResult _result;

            public TResult ConsumeResult()
            {
                var result = _result;
        ...
        class Arg0InvokeFunc<TResult> : ArgInvokeFuncBase<TResult>
        {
            ...
            public void Run() { _result = _action(); }
        }

        class Arg1InvokeFunc<T, TResult> : ArgInvokeFuncBase<TResult>
        {
            ...
            public void Run() { _result = _action(_arg); }
        }

        class Arg2InvokeFunc<T1, T2, TResult> : ArgInvokeFuncBase<TResult>
        {
            ...
            public void Run() { _result = _action(_arg1, _arg2); }
        }

        class Arg3InvokeFunc<T1, T2, T3, TResult> : ArgInvokeFuncBase<TResult>
        {
            ...
            public void Run() { _result = _action(_arg1, _arg2, _arg3); }
        }
    }
}
